...
<?php endif; ?>
<?php $c=1; foreach ($list as $item) : ?>
    <div class="mod-banners__item banneritem <?php if ($c == 1) {echo 'uk-margin-medium-bottom';} ?>">
            ...
            <?php if (BannerHelper::isImage($imageurl)) : ?>
                ...
                <?php if ($item->clickurl) : ?>
                    ...
                    <?php if ($target == 1) : ?>
                        ...
                        <a
                                class="uk-display-block uk-border-rounded uk-overflow-hidden uk-box-shadow-small"
