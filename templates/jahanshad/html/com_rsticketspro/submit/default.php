...
?>
	<div>
		<button type="button" class="uk-button uk-button-primary uk-button-large uk-width-1-1 uk-box-shadow-small uk-box-shadow-hover-medium uk-border-rounded uk-flex-center" onclick="Joomla.submitbutton('submit.save'); this.disabled = true;"><i class="far fa-send fa-flip-horizontal"></i><span><?php echo JText::_('RST_SUBMIT_REQUEST'); ?></span></button>
	</div>
    </div>
