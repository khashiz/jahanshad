...
<div class="uk-width-auto uk-flex uk-flex-middle <?php echo $moduleclass_sfx; ?>">
    <div class="uk-padding-small uk-padding-remove-horizontal">
	    <?php if(count($items)) { ?>
            ...
            <div class="cartDrop" data-uk-drop="pos: bottom-left; offset:0; animation: uk-animation-slide-bottom-small; target: header .uk-container .uk-grid; shift: false; flip: false;">
                <div class="topDrop">
