...
<div class="uk-grid-divider" data-uk-grid>
    <div class="uk-width-1-1 uk-width-expand@s com-content-article item-page<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Article">
	    <?php echo LayoutHelper::render('joomla.content.mag_full_image', $this->item); ?>
        ...
        <div class="page-header">
            <<?php echo $htag; ?> itemprop="headline" class="uk-display-block uk-h3 font f700 uk-text-secondary">
	...
	<?php if ($params->get('access-view')) : ?>
        ...
        <div itemprop="articleBody" class="uk-text-justify uk-text-secondary uk-text-small font com-content-article__body">
